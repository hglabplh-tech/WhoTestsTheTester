...
Let us use a InputStream and OutputStream as interface. The Input / OutputStream do something special and so we use a fake for it. Do not think about a deeper sense I will only show the concept with this example.
\end{flushleft}
