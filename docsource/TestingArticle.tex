...
\node [fill=green,right=of  next9] (next10) {\abbrhighcol{checkin...}};%drawings of lines for the snake
...
\draw[->] (next8.south) -- (next9.west);

\draw[->] (next9.north) -- (next8.east);
...
\abbrhighcol{Example with Java and IntelliJ / Maven}
\begin{enumerate}
\item{define class with functionality}
\item{define constructor}
\item{define public stub}
\item{click right button}
\item{click on Generate -> Test...}
\item{Goto generated Test -> 'name'+Test}
\item{Fill test method with logic / asserts}
\item{Goto src/main.... Class / Method}
\item{implement....}
\item{test....}
\item{checkin....}
\end{enumerate}
...
\end{flushleft}\abbrhighcol{5. Jenkins-Test Environment}\newline\newline
\begin{flushleft}
...
\end{lstlisting}  
The output calling it with all parameters will be:\newline
new Simple Expr: 11 ; new Triple Expr: 7 ; new Double Expr: 12 ; new Fall through Expr: 108 ; new default Expr: 33\newline\newline
