...
\begin{flushleft}
The automation of Tests can take place on different levels of Test execution. At first take a look on test automation of \abbrhighcol{UNIT Tests}
\end{flushleft}
...
\begin{lstlisting}
  ...
  System.out.println("With trap  default: " + pureOldSwitchCaseWithTraps(NONE));\end{lstlisting}
The output will be:\newline
