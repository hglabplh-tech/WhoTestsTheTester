...
One solution here can be:
 ...
 \end{lstlisting}
 Here we introduce a variable for the count initialized by getting the list size. But sometimes we do not have this information in access easily so be careful which method calls you really count.
